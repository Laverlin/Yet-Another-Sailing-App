...
class RaceTimerView280Dc
{
	...
	function PrintTime(dc, time)
	{
		...
		dc.setColor(Settings.ForegroundColor, Settings.BackgroundColor);
        dc.drawText(140, 41, Gfx.FONT_MEDIUM, timeString, Gfx.TEXT_JUSTIFY_CENTER);
	}
	...
	function PrintCountdown(dc, seconds)
	{
		...
		dc.setColor(Settings.ForegroundColor, Settings.BackgroundColor);
        dc.drawText(130, 85, Gfx.FONT_SYSTEM_NUMBER_THAI_HOT, countdownString, Gfx.TEXT_JUSTIFY_CENTER);
	}
	...
	function PrintSpeed(dc, speedKnot)
	{
		...
		dc.setColor(Settings.ForegroundColor, Settings.BackgroundColor);
        dc.drawText(140, 200, Gfx.FONT_MEDIUM, speedString, Gfx.TEXT_JUSTIFY_CENTER);
	}
	...
	{
		dc.setColor(Settings.ForegroundColor, Settings.BackgroundColor);
        dc.drawText(64, 88, Gfx.FONT_LARGE, "+", Gfx.TEXT_JUSTIFY_LEFT);
        dc.drawText(80, 132, Gfx.FONT_MEDIUM, "-", Gfx.TEXT_JUSTIFY_LEFT);
        dc.drawText(140, 200, Gfx.FONT_XTINY, "=", Gfx.TEXT_JUSTIFY_LEFT);
	}
}